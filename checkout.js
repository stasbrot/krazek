...
const CATALOG = {
  ...
  editionSamMix:  { name: 'Edycja Sama Murasa - do wyboru (01/02/05/06)',   amount: 2490 }, // 24,90 zł
  editionStasMix: { name: 'Edycja własna - do wyboru (Gdynia/Szczodrowo)',  amount: 2390 }, // 23,90 zł - ZAŁOŻENIE, potwierdź cenę
